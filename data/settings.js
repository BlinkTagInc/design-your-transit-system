...
module.exports = {
  ...
  text: {
    en: {
      ...
      howItWorksTitle: 'Design your own transit system',
      howItWorksContent: '<ul><li>Scroll down to see the strategies that could improve transit in Black Rock City.</li><li>You have a total budget of 15 dollar signs ($). Mix and match potential improvements to see how the costs and benefits change by clicking the check boxes below.</li><li>Spend your budget by selecting your preferred strategies.</li></ul>',
      ...
      resetTitle: 'Reset',
      submitTitle: 'Submit',
      footerCopyright: '&copy; 2020 <a href="http://blinktag.com">BlinkTag Inc</a>',
