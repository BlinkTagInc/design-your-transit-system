    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-0 md:gap-10">
        <div className="md:col-span-7">
          <div className="py-5 px-8" dangerouslySetInnerHTML={{ __html: settings.text[locale].introText }} />
          <div className="bg-dark rounded-md text-white py-5 px-5 md:px-8 mx-3 md:mx-0 mb-5">
            ...
            <div className="pl-8" dangerouslySetInnerHTML={{ __html: settings.text[locale].howItWorksContent }} />
          </div>
        </div>
        <div className="md:col-span-5">
          <div className="pb-10 md:py-5 px-8 md:py-5">
            <h3 className="mb-2">{ settings.text[locale].benefitCategoriesSectionTitle} </h3>
